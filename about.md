<div class="about-header">
  <img src="assets/perfil.jpg" alt="Portrait of Tomás Barrientos" class="about-avatar" width="160" height="160" loading="lazy" />
  <div class="about-header-content">
    <h1 class="title">Hi, I'm Tomás!</h1>
    <div class="about-socials" style="display:flex;gap:1.25rem;align-items:center;flex-wrap:wrap;margin-top:0.5rem;">

      <a href="https://github.com/brrxs" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
      ...
      <a href="https://linkedin.com/in/tbarrientos" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
      ...
      <a href="mailto:tbarrientos@uc.cl" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" style="width:20px;height:20px;opacity:0.9;">
...
I am a sociologist based in Santiago, Chile, working in data analysis and applied social research. I hold an MSc in Sociology from the Pontificia Universidad Católica de Chile, where I graduated with highest distinction.
